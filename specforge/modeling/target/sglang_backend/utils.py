...
def replaced_logits_processor_forward_for_eagle3(
    ...
    return_last_hidden_states_tail_k: Optional[int] = None,
) -> LogitsProcessorOutput:
    """
    ...
    if return_last_hidden_states:
        if return_last_hidden_states_tail_k is not None:
            last_hidden_states = pruned_states[-return_last_hidden_states_tail_k:]
        else:
...
class LogitsProcessorForEAGLE3(torch.nn.Module):
    def __init__(
        ...
        self.return_last_hidden_states_tail_k: Optional[int] = None
    ...
    def forward(
        ...
        ret = replaced_logits_processor_forward_for_eagle3(
            ...
            self.return_logits,
            self.return_last_hidden_states_tail_k,
        )
        return ret
